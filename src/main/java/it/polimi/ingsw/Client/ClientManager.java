...
/**
 * This class is the link between client and the server
 * All messages received from the server are handled here and there are all the updates to the ClientModel
 * All messages generated by the client are sent to the server through the sendToServer() method
 * */
