...
public enum GameState {
    START_GAME, GOD_PLAYER_CHOOSE_CARDS, SELECT_CARD, GOD_PLAYER_CHOOSE_FIRST_PLAYER, PUT_WORKER, INITURN, CANMOVE, MOVE, INITPOWER, CHECKWIN, CANBUILD, BUILD, CANUSEPOWER, USEPOWER, CHECKIFUSEPOWER, ENDPHASE, BUILDPOWER, SECOND_MOVE, MATCH_ENDED, NULL
