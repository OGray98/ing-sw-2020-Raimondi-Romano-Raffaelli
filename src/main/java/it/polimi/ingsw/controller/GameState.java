...
public enum GameState {
    START_GAME, GOD_PLAYER_CHOOSE_CARDS, SELECT_CARD, GOD_PLAYER_CHOOSE_FIRST_PLAYER, PUT_WORKER, MOVE, INITPOWER, CHECKWIN, BUILD, ENDPHASE, BUILDPOWER, SECOND_MOVE, MATCH_ENDED, NULL
